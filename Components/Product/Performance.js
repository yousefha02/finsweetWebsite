        ...
        <div>
            ...
            <div className="container mx-auto px-6 py-[80px] grid lg:grid-cols-2 gap-7 items-center">
               ...
               <div data-aos="fade-left">
                   <h3 className="title text-[24px] font-semibold">Track your project performance</h3>
                    <h2 className="text-[30px] sm:text-[48px] font-semibold text-btn leading-[40px] md:leading-[60px] mb-2 lg:mb-8">Track your project performance</h2>  
